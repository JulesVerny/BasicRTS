...
public class BaseManager : MonoBehaviour
{
    ...
    public void HarvesterUnload()
    {
        ...
        else
        {
            ...
            if(GameManager.TheGameDifficulty == GameManager.GameDifficultyType.Easy) CurrentBudget = CurrentBudget + TheBaseConfiguration.HarvesterLoad;
            if (GameManager.TheGameDifficulty == GameManager.GameDifficultyType.Medium) CurrentBudget = CurrentBudget + (int)(TheBaseConfiguration.HarvesterLoad*1.15f);
            if (GameManager.TheGameDifficulty == GameManager.GameDifficultyType.Hard) CurrentBudget = CurrentBudget + (int)(TheBaseConfiguration.HarvesterLoad*1.3f);
        }
    ...
    public void HarvesterHalfUnload()
    {
        ...
        if (BaseFaction == GameManager.Faction.Enemy)
        {
            if (GameManager.TheGameDifficulty == GameManager.GameDifficultyType.Easy) CurrentBudget = CurrentBudget + (int)(TheBaseConfiguration.HarvesterLoad*0.5f);
            if (GameManager.TheGameDifficulty == GameManager.GameDifficultyType.Medium) CurrentBudget = CurrentBudget + (int)(TheBaseConfiguration.HarvesterLoad * 0.75f);
    ...
    public void ExcessEntrapmentOffLoad()
    {
        ...
        if (BaseFaction == GameManager.Faction.Enemy)
        {
            ...
            if (GameManager.TheGameDifficulty == GameManager.GameDifficultyType.Hard) CurrentBudget = CurrentBudget + (int)(TheBaseConfiguration.HarvesterLoad * 7.5f);
        }
