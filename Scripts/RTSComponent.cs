...
public class RTSComponent : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        else
        {
            ...
            if (GameManager.TheGameDifficulty == GameManager.GameDifficultyType.Medium) MaxPossibleHealth = (int)(TheRTSComponentConfiguration.MaxHealth * 1.15f);
            if (GameManager.TheGameDifficulty == GameManager.GameDifficultyType.Hard) MaxPossibleHealth =  (int)(TheRTSComponentConfiguration.MaxHealth * 1.3f);
        }
