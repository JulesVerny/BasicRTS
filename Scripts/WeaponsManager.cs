...
public class WeaponsManager : MonoBehaviour
{
    ...
    public void FireWeapon()
    {
        if(Time.time > NextFireTime) 
        {
            ...
            {
                if (GameManager.TheGameDifficulty == GameManager.GameDifficultyType.Medium) WeaponsFireDamage = (int)(WeaponsFireDamage * 1.15f);
                if (GameManager.TheGameDifficulty == GameManager.GameDifficultyType.Hard) WeaponsFireDamage =  (int)(WeaponsFireDamage * 1.3f);
            }
