...
public class EnemyAIManager : MonoBehaviour
{
    ...
    public int NumberofPlayerTanks;
    public int NumberofAIHumvees;
    public int NumberofPlayerHumvees;
    public int NumberofAIBaseDefences;
    public int NumberofPlayerBaseDefences;
...
[Header("AI Debug UI ")]
    ...
    bool ReviewCurrentStrategy()
    {
        ...
        if (RandomChoice100 < 30) ReviseBuildStrategyChoice();
    ...
    private void ReviseBuildStrategyChoice()
    {
        ...
        int RandomChoice100 = Random.Range(0, 100);
        if (RandomChoice100 < 10) CurrentAIBuildStrategy = BuildQueStratgyType.Mixed;
        if ((RandomChoice100 >= 10) && (RandomChoice100 < 40)) CurrentAIBuildStrategy = BuildQueStratgyType.HumveeFest;
        if ((RandomChoice100 >= 40) && (RandomChoice100 < 70)) CurrentAIBuildStrategy = BuildQueStratgyType.HardTank;
        if ((RandomChoice100 >= 70) && (RandomChoice100 < 80))
        {
        ...
        if ((RandomChoice100 >= 80) && (RandomChoice100 <= 100))
        {
            ...
            else
            {
                ...
                if (RandomChoice100 < 50) CurrentAIBuildStrategy = BuildQueStratgyType.HardTank;
                if ((RandomChoice100 >= 50) && (RandomChoice100 < 90)) CurrentAIBuildStrategy = BuildQueStratgyType.HumveeFest;
